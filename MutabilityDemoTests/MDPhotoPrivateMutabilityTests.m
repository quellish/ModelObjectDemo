...
@interface MDPhotoPrivateMutabilityTests : XCTestCase

@end

@implementation MDPhotoPrivateMutabilityTests
...
- (Class)testClass {
    return [MDPhotoPrivateMutability class];
}
